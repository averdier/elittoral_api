...
analysis_result = api.inherit('AnalysisResult', analysis_post, {
    'id' : fields.Integer(required=True, description='AnalysisResult unique Id'),
    'created_on' : fields.DateTime(dt_format='iso8601', required = True, description = 'Datetime of AnalysisResult creation (iso8601)'),
...
analysis_base = api.model('Analysis', {
    ...
    'created_on' : fields.DateTime(dt_format='iso8601', required = True, description = 'Datetime of Analysis creation (iso8601)'),
